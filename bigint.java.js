...
var use_applet = true;//(navigator.appName == "Microsoft Internet Explorer") || (!is_ns4 && navigator.platform.substr(0, 5) == "Linux") || str_workaround;
...
function bigint_footer() {
  if(use_applet) {
    document.write('<applet mayscript name="bigint" code="bigint.class" width=1 height=1 MAYSCRIPT=true><PARAM NAME="scriptable" VALUE="true"></applet>'); // jshint ignore:line
  }
}
